...
//    public static String msg="";
    ...
    public MyMerger() throws IOException {
    }
...
//                }
            ...
            for (KmlObject object:mergedBucket){
                ...
                for(point point : object.getPoints()) {
                    ...
                    if (cl == 0)
                        curPoints = curPoints +point.getLatitude() + " " + point.getLongitude();
                    else
                        curPoints = curPoints + "," + point.getLatitude() + " " + point.getLongitude();
                    cl++;
                ...
                tempDir.put("coordinates",curPoints);
                tempDir.put("version",Integer.toString(version));
                tempDir.put("flag",flag);
                tempDir.put("metadata",mapName);
                tempDir.put("position",position);
//                msg=msg+"%"+Integer.toString(version)+"%"+flag+"%"+mapName+"%"+position+"%"+clusterString;
//                msg=msg+"\n";
                mergedContent.add(tempDir);
...
//                msg=msg+"\n";
                ...
                tempDir.put("metadata",video.getName());
                mergedContent.add(tempDir);
                //System.out.println(msg);
            }
        }
...
//                msg=msg+"\n";
                ...
                tempDir.put("version",Integer.toString(version));
                tempDir.put("flag","normal");
                tempDir.put("metadata",audio.getName());
                mergedContent.add(tempDir);
                //System.out.println(msg);
            }
        }
...
//                msg=msg+"\n";
                ...
                tempDir.put("version",Integer.toString(version));
                tempDir.put("flag","normal");
                tempDir.put("metadata",image.getName());
                mergedContent.add(tempDir);
                //System.out.println(msg);
            }
        }
...
//                msg=msg+"\n";
                ...
                tempDir.put("version",Integer.toString(version));
                tempDir.put("flag","normal");
                tempDir.put("metadata",text.getName());
                mergedContent.add(tempDir);
                //System.out.println(msg);
            }
        }
...
//        System.out.println(msg);
        ...
        for (HashMap<String,Object> cont : mergedContent)
        {
            ...
            myjson.add(jsonObject);
        }
        ObjectMapper objectMapper = new ObjectMapper();
        ultimateJson ujs = new ultimateJson(myjson,Integer.toString(version));
